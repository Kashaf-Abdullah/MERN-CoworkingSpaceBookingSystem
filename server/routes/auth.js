...
//       'your_jwt_secret', // Replace with a secure key in production
//       { expiresIn: '1h' }
//     );
...
router.post('/signup', upload.single('profilePicture'), async (req, res) => {
  const { email, username, password, phoneNumber, companyName, position, bio, communicationPreferences, workspacePreferences } = req.body;
